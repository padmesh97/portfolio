...
<body>
	...
	if($sup==$batman && isset($_POST['name']) && strlen($sup)>0)
	{
		...
		<div>
			<nav>
				<div class="nav-wrapper brown darken-2" style="display: flex;justify-content: center">
					<img src="logo2.png" style="max-height: 60px; margin-top: 5px; margin-right: 30px">

					<a href="#" style="font-family: 'Roboto', sans-serif;font-size: 30px">Certificate Module Generator</a>

					<img src="logo2.png" style="max-height: 60px; margin-top: 5px;margin-left:30px">
				...
				<div class="row">
					...
					<div class="input-field col s6" id="elements" style="display: none;">
						<form action="send.php" method="GET">
							<input id="email" disabled type="text" name="email" class="validate" placeholder="Feature disabled for Guest users">
						</div>
					</div>
					<!-- send email button -->
					...
					<div class="row">
						...
						<button disabled action="submit" class="btn waves-effect waves-light col s2 offset-s5 #6d4c41 brown darken-1" style="font-family: 'Roboto', sans-serif; display: none;" id="elementss">Send Email</button>
					</form>
				</div>
	...
	if(!isset($_POST['name']) || ($sup!=$batman))
	{
		...
		<div class="content" style="max-width: 500px; margin: auto;">
			...
			<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
				<input id="pass_check" type="password" name="name" placeholder="Guest users try 'anonymous'">
				<br><br>
